...
with tab2:
  ...
  st.checkbox(
      "Verified structure contains zero Protected Health Information (PHI).", key="attest_check_1"
  )
  st.checkbox("Validated exception flagging logic against administrative standard rules.", key="attest_check_2")
